...
import "./TestTraditionalML.css";

function TestTraditionalML() {
  ...
  return (
    <div
      className="test-traditional-ml"
      style={{
        backgroundImage: `url('/bg.jpg')`,
      }}
    >
      <div className="content">
        <h1 className="heading">Traditional ML CLassifier</h1>
...
export default TestTraditionalML;
